We say $f: D \subseteq \mathbb{R} \rightarrow \mathbb{R}$ is **continuous** on $D$ if **$\forall\{x_n\}$ in $D$ whenever $x_n \rightarrow x_0 \in D$, it follows that $f(x_n) \rightarrow f(x_0)$.**
